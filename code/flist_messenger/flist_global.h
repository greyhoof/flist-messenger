...
#define FLIST_VERSIONNUM "0.9.6." GIT_HASH
#define FLIST_PRETTYVERSION "0.9.6." GIT_REV " (commit " GIT_HASH ")"
#define FLIST_SHORTVERSION "0.9.6." GIT_REV
...
// #define FLIST_CHAT_SERVER "wss://chat.f-list.net/chat-dev"
