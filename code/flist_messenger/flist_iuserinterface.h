...
class iUserInterface {
    public:
        ...
        virtual void messageMany(FSession *session, QList<QString> &channels, QList<QString> &characters, bool system, FMessage message) = 0;
        virtual void messageAll(FSession *session, FMessage message) = 0;
        virtual void messageChannel(FSession *session, QString channelname, FMessage message, bool console = false, bool notify = false) = 0;
        virtual void messageCharacter(FSession *session, QString charactername, FMessage message) = 0;
        virtual void messageSystem(FSession *session, FMessage message) = 0;
